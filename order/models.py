...
class Order(models.Model):
    first_name = models.CharField(max_length=50) # 성
    last_name = models.CharField(max_length=50) # 이름
...
class OrderTransactionManager(models.Manager): # 장고의 모델의 매니저를 상속받음
...
# 시그널을 활용한 결제 검증 함수 (시그널이란 특정 기능이 수행되었음을 장고 애플리케이션 전체에 알리는 용도)
